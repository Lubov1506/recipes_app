...
export const useRecipeStore = create<IRecipeState>((set) => ({
  ...
  loadRecipes: async () => {
    ...
    try {
      ...
      set({ error: "Loading recipes error", isLoading: false })
    }
  },
  addRecipe: async (formData: FormData) => {
    ...
    try {
      ...
      console.log(error, "error")
      set({ error: "Adding recipes error", isLoading: false })
      return { success: false, error: "Adding recipes error" }
    }
  },
  updateRecipe: async (id: string, formData: FormData) => {
    ...
    try {
      ...
      console.log(error, "error")
      set({ error: "Updating recipes error", isLoading: false })
  ...
  removeRecipe: async (id: string) => {
    ...
    try {
      ...
      console.log(error, "error")
      set({ error: "Deleting recipes error", isLoading: false })
    }
  },
}))
